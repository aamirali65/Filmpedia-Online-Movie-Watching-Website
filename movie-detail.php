...
<section class="section details">
		...
		<div class="container">
			<div class="row">
                ...
                $query = mysqli_query($con, "SELECT * FROM add_movies WHERE id = '$data'");
                if($query){
                while($row = mysqli_fetch_assoc($query)){
                    ?>
				<div class="col-12">
					<h1 class="details__title"><?php echo $row['Movie_Name']?></h1>
				</div>
				<!-- end title -->
						...
						<div class="row">
							...
							<div class="col-12 col-sm-8 col-md-8 col-lg-9 col-xl-9">
								<div class="card__content">
									...
									<div class="card__description card__description--details"><?php echo $row['movie_desc']?></div>
								</div>
							</div>
							<!-- end card content -->
						</div>
				...
				<a href="<?php echo $row['link']?>" target="_blank" id="a"><input type="button" value="Link 1" class="in"></a>
				<a href="<?php echo $row['link2']?>" id="b" target="_blank"><input type="button" value="Link 2" class="in"></a>
...
<section class="content">
        ...
        <div class="container">
			<div class="row">
                ...
                <?php
					include './Admin/config.php';
					$query = mysqli_query($con , "SELECT * FROM `add_movies` ORDER BY RAND() LIMIT 6");
					if($query){
						while($row = mysqli_fetch_assoc($query)){
							$ql =  $row['id'];
