...
include 'config.php';
$newid = $_GET['id'];
$query = mysqli_query($con, "SELECT * FROM add_webs WHERE id = '$newid'");
if($query){
...
<div class="container">
    ...
    <h1 class="my-4 mx-5"><?php echo $row['web_name']?></h1>
    <div class="row mx-5">
      ...
      <div class="col-md-5">
        <ul class="card__meta">
			...
			<li><span>Genre:</span> <a href="#"><?php echo $row['genre_id']?></a> |
